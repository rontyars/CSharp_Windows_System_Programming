...
namespace MyNetwork
{
    public class Message
    {
        ...
        protected string _messageHeader = "[TEXT]";
        ...
        public bool FinalOfBufferedPacket { get; set; }
        public Message()
        {
        ...
        private static void SetProperty(PropertyInfo property, object output, object value)
        {
            try
            {
        ...
        private static Int16[] byteToArray(byte[] b, Int32 itemCount)
        {
            int i = 0;
            int index = 0;
        ...
        private static Object extract(byte[] data, ref int index, Object var, int start = 0, int length = 0)
        {
        ...
        private static TypeCode GetTypeCode(FieldInfo field, object temp)
        {
            if (temp != null)
            {
        ...
        private static TypeCode GetPropertyTypeCode(PropertyInfo property, object temp)
        {
            if (temp != null)
            {
                return Type.GetTypeCode(temp.GetType());
